        ...
        "input_schema": {
            ...
            "properties": {
                "app_name": {
                    ...
                    "description": "The name of the application to launch. Must be one of the allowed apps: 小红书 (lifestyle sharing), 美团 (food delivery & services), 大众点评 (restaurant reviews), 高德地图 (navigation), 抖音 (short videos), 淘宝 (e-commerce), 京东 (e-commerce), 携程 (travel booking), bilibili (videos), 微博 (social media), 快手 (short videos), 去哪儿 (travel), 百度地图 (maps), 微信 (messaging), 飞书 (collaboration), 腾讯视频 (streaming), QQ音乐 (music), 腾讯新闻 (news), keep (fitness), 汽水音乐 (music), 爱奇艺 (streaming), 芒果TV (streaming), 红果短剧 (short dramas), 网易云音乐 (music), 贝壳找房 (real estate), 安居客 (real estate), 七猫免费小说 (novels), 番茄免费小说 (novels), 喜马拉雅 (audio), QQ邮箱 (email), 知乎 (Q&A community), 拼多多 (e-commerce), 饿了么 (food delivery), 淘宝闪购 (food delivery), 京东秒送 (food delivery), 应用宝 (app store), 美柚 (women's health), 今日头条 (news), 滴滴出行 (ride-hailing), 优酷视频 (streaming), QQ (messaging), 快手极速版 (short videos), 肯德基 (KFC), 豆瓣 (reviews & community), 同花顺 (stocks), 支付宝 (payment & services), 豆包 (AI chatting), 星穹铁道 (Role-playing game), 恋与深空 (virtual romance & character development game)"
                }
            },
            "required": ["app_name"]
        }
